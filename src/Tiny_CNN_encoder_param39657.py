...
def train_encoder(
    ...
    save_path = os.path.join(save_dir, f"tiny_feature_encoder_100_earlystop_{date_str}.pth")
    ...
    train_dataset = MultiModalDataset(train_df_sub, X_train_basic, rasterizer, y_train)
    val_dataset   = MultiModalDataset(val_df_sub,   X_val_basic,   rasterizer, y_val)
