...
class ProductionPipeline:
    ...
    def run_production_pipeline(self):
        ...
        submission.to_csv("./data/CNN_MLP_RandomForest_submission.csv", index=False)
        print("Saved submission to ./data/CNN_MLP_RandomForest_submission.csv")
